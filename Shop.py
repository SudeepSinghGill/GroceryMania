...
@app.route('/AddVegetables',methods=['POST', 'GET'])
...
def Fruits():
    with connection.cursor() as cursor:
        cursor.execute("SELECT * FROM products WHERE Product_Type = 'Fruits' ORDER BY Product_ID ASC")
        row_count = cursor.rowcount
        result = cursor.fetchall()
    return render_template('Fruits.html',data = result)

@app.route('/AddFruits',methods=['POST', 'GET'])
def AddCartFruits():
    if request.method=='POST':
        global flag
        global sum
...
def Grains():
    with connection.cursor() as cursor:
        cursor.execute("SELECT * FROM products WHERE Product_Type = 'GrainsAndPulses' ORDER BY Product_ID ASC")
        row_count = cursor.rowcount
        result = cursor.fetchall()
    return render_template('Grains.html',data = result)

@app.route('/AddGrains',methods=['POST', 'GET'])
def AddCartGrains():
    if request.method=='POST':
        global flag
        global sum
        ...
        if ID in cart.keys():
            ...
            sum = sum + cart[ID]['Amount']
            flag = 1
        return redirect(url_for('Grains'))
		
@app.route('/Dairy')
def Dairy():
    with connection.cursor() as cursor:
        cursor.execute("SELECT * FROM products WHERE Product_Type = 'BakeryAndDairy' ORDER BY Product_ID ASC")
        row_count = cursor.rowcount
        result = cursor.fetchall()
    return render_template('Dairy.html',data = result)

@app.route('/AddDairy',methods=['POST', 'GET'])
def AddCartDairy():
    if request.method=='POST':
        global flag
        global sum
...
def Beverages():
    with connection.cursor() as cursor:
        cursor.execute("SELECT * FROM products WHERE Product_Type = 'Beverages' ORDER BY Product_ID ASC")
        row_count = cursor.rowcount
        result = cursor.fetchall()
    return render_template('Beverages.html',data = result)

@app.route('/AddBeverages',methods=['POST', 'GET'])
def AddCartBeverages():
    if request.method=='POST':
        global flag
        global sum
        Name = request.form['name']
...
def Cleaning():
    with connection.cursor() as cursor:
        cursor.execute("SELECT * FROM products WHERE Product_Type = 'CleaningAndHousehold' ORDER BY Product_ID ASC")
        row_count = cursor.rowcount
        result = cursor.fetchall()
    return render_template('Cleaning.html',data = result)

@app.route('/AddCleaning',methods=['POST', 'GET'])
def AddCartCleaning():
    if request.method=='POST':
        global flag
        global sum
...
def Beauty():
    with connection.cursor() as cursor:
        cursor.execute("SELECT * FROM products WHERE Product_Type = 'BeautyAndHygiene' ORDER BY Product_ID ASC")
        row_count = cursor.rowcount
        result = cursor.fetchall()
    return render_template('Beauty.html',data = result)

@app.route('/AddBeauty',methods=['POST', 'GET'])
def AddCartBeauty():
    if request.method=='POST':
        global flag
        global sum
...
def Snacks():
    with connection.cursor() as cursor:
        cursor.execute("SELECT * FROM products WHERE Product_Type = 'Snacks' ORDER BY Product_ID ASC")
        row_count = cursor.rowcount
        result = cursor.fetchall()
    return render_template('Snacks.html',data = result)

@app.route('/AddSnacks',methods=['POST', 'GET'])
def AddCartSnacks():
    if request.method=='POST':
        global flag
        global sum
...
def BabyCare():
    with connection.cursor() as cursor:
        cursor.execute("SELECT * FROM products WHERE Product_Type = 'BabyCare' ORDER BY Product_ID ASC")
        row_count = cursor.rowcount
        result = cursor.fetchall()
    return render_template('BabyCare.html',data = result)

@app.route('/AddBabyCare',methods=['POST', 'GET'])
def AddCartBabyCare():
    if request.method=='POST':
        global flag
        global sum
        ...
        if ID in cart.keys():
            ...
            sum = sum + cart[ID]['Amount']
            flag = 1
        return redirect(url_for('BabyCare'))
...
@app.route('/cancelOrder/<string:id>')
def cancelOrder(id):
    with connection.cursor() as cursor:
        cursor.execute("delete FROM orderdetails where Order_ID = %s",(id))
        connection.commit()
